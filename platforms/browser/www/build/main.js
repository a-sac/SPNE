...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic2_pincode_input__ = __webpack_require__(165);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_ionic_angular__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_crypto_js__ = __webpack_require__(365);
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return EmailAdr; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ionic_storage__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__app_services_home_service__ = __webpack_require__(52);
...
var EmailAdr = /** @class */ (function () {
    function EmailAdr(navCtrl, storage, homeService, alertCtrl) {
        this.navCtrl = navCtrl;
        this.storage = storage;
    ...
    EmailAdr = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'emailadr',template:/*ion-inline-start:"/home/sergio/Desktop/asac/SPNE/src/pages/emailadr/emailadr.html"*/'<ion-header style="color:#143363">\n    <ion-navbar color="white">\n        <ion-title text-center>\n            Adesão ao SPNE\n        </ion-title>\n    </ion-navbar>\n</ion-header>\n<ion-content *ngIf="user" padding >\n    <div *ngIf="user.nome" style="margin: 10px">\n            Bem Vindo\n            <b>{{user.nome}}</b>\n            <br>\n            CC: {{user.cc}}\n            <br>\n    </div>\n\n    <div *ngIf="show">\n        <div style="margin: 20px">\n            <span style="color: blue">Termos e Condições</span>\n\n            <br>\n                Ferrars all spirits his imagine effects amongst neither. It bachelor cheerful of mistaken. Tore has sons put upon wife use bred seen. Its dissimilar invitation ten has discretion unreserved. Had you him humoured jointure ask expenses learning. Blush on in jokes sense do do. Brother hundred he assured reached on up no. On am nearer missed lovers. To it mother extent temper figure better. \n\n                In show dull give need so held. One order all scale sense her gay style wrote. Incommode our not one ourselves residence. Shall there whose those stand she end. So unaffected partiality indulgence dispatched to of celebrated remarkably. Unfeeling are had allowance own perceived abilities. \n        </div>\n\n        <div class="btn-wrapper">\n            <button ion-button (click)="entrar()">LI E ACEITO</button>\n        </div>\n    </div>\n    <div *ngIf="showEA">\n        <div style="margin: 20px">\n            <span style="color: blue">Morada Única Digital (M.U.D.)</span>\n\n            <br>\n            <form *ngIf="user.email" (ngSubmit)="toggleEA()">\n                <ion-item>\n                    <ion-label>MUD:</ion-label>\n                    <ion-input [(ngModel)]="ea" name="ea" value="{{user.email}}"></ion-input>\n                </ion-item>\n                <ion-item>\n                    <ion-label>Confirmação:</ion-label>\n                    <ion-input [(ngModel)]="eac" name="eac" value="{{user.email}}"></ion-input>\n                </ion-item>\n                <button ion-button type="submit" block style="background-color: #143363;">Confirmar</button>\n            </form>\n                \n        </div>\n\n    </div>\n    <div *ngIf="showEAT">\n        <div style="margin: 20px">\n            <span style="color: blue">Confirmação da Morada Única Digital (M.U.D.)</span>\n\n            <br>\n            Foi enviado um email para o endereço de email\n            que indicou.\n            Para concluir a adesão, consulte a sua caixa de\n            correio eletrónica e clique no link Confirmar MUD\n            na mensagem que recebeu.\n\n            <form (ngSubmit)="toggleEAT()">\n                <ion-item>\n                    <ion-label>Token:</ion-label>\n                    <ion-input [(ngModel)]="eat" name="eat"></ion-input>\n                </ion-item>\n                <button ion-button type="submit" block style="background-color: #143363;">Confirmar</button>\n            </form>\n                \n        </div>\n    </div>\n    <div *ngIf="showTEL">\n            <div style="margin: 20px">\n                <span style="color: blue">Telemóvel</span>\n    \n                <br>\n                <form *ngIf="user.telemovel" (ngSubmit)="toggleTEL()">\n                    <ion-item>\n                        <ion-label>Telemóvel:</ion-label>\n                        <ion-textarea [(ngModel)]="tel" name="tel" value="{{user.telemovel}}"></ion-textarea>\n                    </ion-item>\n                    <ion-item>\n                        <ion-label>Confirmação:</ion-label>\n                        <ion-textarea [(ngModel)]="telc" name="telc" value="{{user.telemovel}}"></ion-textarea>\n                    </ion-item>\n                    <button ion-button type="submit" block style="background-color: #143363;">Confirmar</button>\n                </form>\n                    \n            </div>\n    \n        </div>\n    <div *ngIf="showTELT">\n        <div style="margin: 20px">\n            <span style="color: blue">Confirmação do Telemóvel</span>\n\n            <br>\n            Foi enviado uma mensagem para o telemóvel\n            que indicou.\n            Para concluir a adesão, consulte o seu\n            telemóvel e coloque a token.\n\n            <form (ngSubmit)="toggleTELT()">\n                <ion-item>\n                    <ion-label>Token:</ion-label>\n                    <ion-textarea [(ngModel)]="telt" name="telt"></ion-textarea>\n                </ion-item>\n                <button ion-button type="submit" block style="background-color: #143363;">Confirmar</button>\n            </form>\n                \n        </div>\n    </div>\n</ion-content>\n\n'/*ion-inline-end:"/home/sergio/Desktop/asac/SPNE/src/pages/emailadr/emailadr.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* NavController */], __WEBPACK_IMPORTED_MODULE_2__ionic_storage__["b" /* Storage */], __WEBPACK_IMPORTED_MODULE_3__app_services_home_service__["a" /* HomeService */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */]])
    ], EmailAdr);
    return EmailAdr;
}());

//# sourceMappingURL=emailadr.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ionic_storage__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__auth_auth__ = __webpack_require__(98);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__app_services_home_service__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__emailadr_emailadr__ = __webpack_require__(169);
...
var KeyPage = /** @class */ (function () {
        ...
        this.storage.get('key').then(function (pwd) {
            if (pwd) {
                _this.storage.get('token').then(function (pwd2) {
                    if (pwd2) {
                        _this.storage.get('adesao').then(function (pwd3) {
                            if (pwd3) {
                                console.log(pwd3);
                                ...
                                _this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_5__emailadr_emailadr__["a" /* EmailAdr */], {
                                    storage: _this.storage
                                });
                            }
                        });
    ...
    KeyPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'key',template:/*ion-inline-start:"/home/sergio/Desktop/asac/SPNE/src/pages/key/key.html"*/'<ion-header>\n    <ion-navbar color="favorite">\n      <ion-title text-center>\n          Chave Móvel Digital\n      </ion-title>\n    </ion-navbar>\n</ion-header>\n  \n<ion-content padding>\n    <div *ngIf="show">\n        <form (ngSubmit)="toggleKey()">\n            <ion-item>\n                <ion-label>Chave Móvel Digital:</ion-label>\n                <ion-textarea [(ngModel)]="key" name="key"></ion-textarea>\n            </ion-item>\n            <button ion-button type="submit" block style="background-color: #143363;">Confirmar</button>\n        </form>\n        <form (ngSubmit)="toggleBA()">\n            <button ion-button type="submit" block style="background-color: #143363;">Voltar Atrás</button>\n        </form>\n    </div>  \n    <div *ngIf="showT">\n        <form (ngSubmit)="toggleToken()">\n            <ion-item>\n            <ion-label>Token:</ion-label>\n            <ion-textarea [(ngModel)]="token" name="token"></ion-textarea>\n            </ion-item>\n            <button ion-button type="submit" block style="background-color: #143363;">Confirmar</button>\n        </form>\n        <form (ngSubmit)="toggleBC()">\n            <button ion-button type="submit" block style="background-color: #143363;">Voltar Atrás</button>\n        </form>\n    </div>\n</ion-content>\n  '/*ion-inline-end:"/home/sergio/Desktop/asac/SPNE/src/pages/key/key.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* NavController */], __WEBPACK_IMPORTED_MODULE_2__ionic_storage__["b" /* Storage */], __WEBPACK_IMPORTED_MODULE_4__app_services_home_service__["a" /* HomeService */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* MenuController */]])
    ], KeyPage);
    return KeyPage;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ionic_storage__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__app_services_home_service__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__auth_auth__ = __webpack_require__(98);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ionic_native_splash_screen__ = __webpack_require__(170);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__slides_slides__ = __webpack_require__(369);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_ionic_angular__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ionic2_pincode_input_dist__ = __webpack_require__(165);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_native_fingerprint_aio__ = __webpack_require__(162);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_crypto_js__ = __webpack_require__(365);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__auth_auth__ = __webpack_require__(98);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__pages_settings_settings__ = __webpack_require__(164);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pages_tabs_tabs__ = __webpack_require__(735);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__pages_key_key__ = __webpack_require__(368);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pages_slides_slides__ = __webpack_require__(369);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_ionic_angular__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pages_auth_auth__ = __webpack_require__(98);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__pages_splash_splash__ = __webpack_require__(370);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__pages_details_details__ = __webpack_require__(267);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__pages_emailadr_emailadr__ = __webpack_require__(169);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__ionic_native_splash_screen__ = __webpack_require__(170);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__ionic_native_status_bar__ = __webpack_require__(371);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__angular_platform_browser_animations__ = __webpack_require__(736);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__ionic_storage__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__angular_http__ = __webpack_require__(268);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__angular_common_http__ = __webpack_require__(738);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__app_component__ = __webpack_require__(739);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__pages_lock_screen_lock_screen__ = __webpack_require__(373);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20_ionic2_pincode_input__ = __webpack_require__(165);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__ionic_native_fingerprint_aio__ = __webpack_require__(162);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22_ngx_qrcode2__ = __webpack_require__(740);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__ionic_native_barcode_scanner__ = __webpack_require__(760);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24_ionic2_material_icons__ = __webpack_require__(761);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_11__angular_core__["I" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_19__pages_lock_screen_lock_screen__["a" /* LockScreenPage */],
                ...
                __WEBPACK_IMPORTED_MODULE_9__pages_emailadr_emailadr__["a" /* EmailAdr */]
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_14__angular_platform_browser_animations__["a" /* BrowserAnimationsModule */],
                __WEBPACK_IMPORTED_MODULE_10__angular_platform_browser__["a" /* BrowserModule */],
                __WEBPACK_IMPORTED_MODULE_20_ionic2_pincode_input__["PincodeInputModule"],
                ...
                __WEBPACK_IMPORTED_MODULE_5_ionic_angular__["h" /* IonicModule */].forRoot(__WEBPACK_IMPORTED_MODULE_18__app_component__["a" /* MyApp */], {}, {
                    links: []
                }),
                __WEBPACK_IMPORTED_MODULE_15__ionic_storage__["a" /* IonicStorageModule */].forRoot(),
                __WEBPACK_IMPORTED_MODULE_24_ionic2_material_icons__["a" /* MaterialIconsModule */]
            ],
            ...
            providers: [
                ...
                { provide: __WEBPACK_IMPORTED_MODULE_11__angular_core__["u" /* ErrorHandler */], useClass: __WEBPACK_IMPORTED_MODULE_5_ionic_angular__["g" /* IonicErrorHandler */] }
            ]
        })
    ], AppModule);
    return AppModule;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__details_details__ = __webpack_require__(267);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__app_services_home_service__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__angular_platform_browser__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_native_fingerprint_aio__ = __webpack_require__(162);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var HomePage = /** @class */ (function () {
    function HomePage(loadingCtrl, plt, navCtrl, sanitizer, navParams, homeService, alertCtrl, ffaio) {
    ...
    HomePage.prototype.faio = function () {
        var _this = this;
        this.ffaio.isAvailable().then(function (result) {
            if (result === "OK") {
    ...
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"/home/sergio/Desktop/asac/SPNE/src/pages/home/home.html"*/'<ion-header>\n  <ion-navbar color="white" style="color: #143363">\n\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n\n    <ion-title text-center>PNE</ion-title>\n\n  </ion-navbar>\n</ion-header>\n<ion-content padding>\n  <ion-item *ngIf="user">\n      <ion-select style="width: 100%; max-width: 100% !important;"[(ngModel)]="usersel" name="usersel" value="usersel" placeholder="{{usersel}}">\n        <ion-option value="1">{{user.nome}}</ion-option>\n        <ion-option value="2">Mário José Morais Soares</ion-option>\n        <ion-option value="3">Morais Soares, Lda</ion-option>\n    </ion-select>\n  </ion-item>\n  <ion-list>\n    <div *ngIf="messages" >\n    <div *ngIf="messages.data" >\n    <ion-item *ngFor="let i of messages.data;" [ngStyle]="{\'border-color\': colors[i.tipo]}"  style=" border: solid; border-top-width: 0.1px; border-bottom-width: 0.1px; border-right-width: 0.1px; border-left-width: 10px; margin: 20px 0px">\n      <ion-grid>\n        <ion-row>\n          <ion-col col-12>\n            <div style="col-md-12" (click)="viewItem(i)">\n              <ion-thumbnail *ngIf="i.imagem && i.imagem != null" item-left>\n                <img src="{{i.imagem}}">\n              </ion-thumbnail>\n              <h4 style="color:gray"> {{i.entidade}}</h4>\n              <b><h2>{{i.titulo}}</h2></b>\n              <div [ngStyle]="{\'border-color\': colors[i.tipo]}" style="border:solid; display: inline-block; border-radius: 10px; margin: 0.2em 0em 2em 0em">\n                <h6 [ngStyle]="{\'color\': colors[i.tipo]}" style="padding: 2px 8px;  top: 2px; width: 100%; position: relative;">{{i.tipo}}</h6>\n              </div>\n              <div style="border: solid ; white-space:normal;  border-color:gray; padding: 20px 10px">\n                <h2 style="color:gray ;   overflow-wrap: break-word; word-wrap: break-word; hyphens: auto;">{{i["linha-1"]}}</h2> \n                <h2 style="color:gray;   overflow-wrap: break-word; word-wrap: break-word; hyphens: auto;">{{i["linha-2"]}}</h2>\n                <div *ngIf="date1" >\n                  <ion-item>\n                  <span>\n                    <div style="word-wrap:break-word">\n                      <ion-icon md-name="access_time" style="position: relative; top: 4px;"></ion-icon>\n                      <span>Valido até {{date1.toISOString().substring(0, 10)}}</span>\n                    </div>\n                  </span>\n                  </ion-item>\n                </div>\n              </div>\n            </div>\n          </ion-col >\n        </ion-row>\n      </ion-grid>\n    </ion-item>\n    </div>\n    </div>\n  </ion-list>\n</ion-content>\n'/*ion-inline-end:"/home/sergio/Desktop/asac/SPNE/src/pages/home/home.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* LoadingController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["p" /* Platform */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_4__angular_platform_browser__["c" /* DomSanitizer */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["o" /* NavParams */], __WEBPACK_IMPORTED_MODULE_3__app_services_home_service__["a" /* HomeService */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */], __WEBPACK_IMPORTED_MODULE_5__ionic_native_fingerprint_aio__["a" /* FingerprintAIO */]])
    ], HomePage);
    return HomePage;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__settings_settings__ = __webpack_require__(164);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pages_splash_splash__ = __webpack_require__(370);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__services_home_service__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ionic_native_status_bar__ = __webpack_require__(371);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ionic_native_splash_screen__ = __webpack_require__(170);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__pages_home_home__ = __webpack_require__(50);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__pages_settings_settings__ = __webpack_require__(164);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__key_key__ = __webpack_require__(368);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__emailadr_emailadr__ = __webpack_require__(169);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__app_services_home_service__ = __webpack_require__(52);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
